...
class Game2048(gl.Contract):
    ...
    def _calc_score(self, old_row: list, new_row: list) -> int:
        s = 0
        for i in range(GRID_SIZE):
            if new_row[i] != old_row[i] and new_row[i] != 0 and old_row[i] != 0:
                s += new_row[i]
        return s
    ...
    def init_game(self) -> str:
        ...
        # Simple deterministic init: place two tiles
        g[0][0] = 2
        g[1][1] = 2
